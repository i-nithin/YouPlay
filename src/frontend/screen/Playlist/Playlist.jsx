...
import { deleteplaylistService } from "../../services/playlistSerivces/deletePlaylistService";
...
function Playlist() {
  ...
  const currentPlaylist = playlistState.find(
    ...
    <div className="explore-main-container">
      ...
      currentPlaylist.videos.length > 0 ? (
        <div className="morepages-container">
          <div className="morepages-video">
            <div className="p-relative">
              <img
                src={`https://img.youtube.com/vi/${currentPlaylist?.videos[0]?._id}/maxresdefault.jpg`}
                alt="img"
                height="100%"
                width="100%"
              />
              <div className="morepages-title">
                ...
                <button
                  className="d-flex align-center icon-btn"
          ...
          <div className="morepages-list-container">
            {currentPlaylist?.videos?.map((video, index) => {
              return <SmallVideoCard key={index} video={video} />;
            })}
          </div>
        </div>
      ) : (
        <div>
          ...
          <button
            className="eplaybtn eplaybtn-primary"
            onClick={deletePlaylist}
          >
            {" "}
            Delete playlist{" "}
